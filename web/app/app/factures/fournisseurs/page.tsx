...
export default function FacturesFournisseursPage() {
  ...
  const kpis = [
    t("app.facturesFournisseurs.totalPayer"),
    t("app.facturesFournisseurs.echeance"),
    t("app.facturesFournisseurs.payeMois"),
    t("app.facturesFournisseurs.dpo"),
  ]
      ...
      <Card>
        ...
        <CardContent>
          <div className="h-64 flex items-center justify-center text-[#64748B] text-sm">
            {t("app.facturesFournisseurs.placeholder")}
          </div>
        </CardContent>
      </Card>
    </div>
